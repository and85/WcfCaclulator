...
namespace ClientApp.AutoGeneratedServiceReference {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="SomeData", Namespace="http://schemas.datacontract.org/2004/07/Common.DataContracts")]
    [System.SerializableAttribute()]
    public partial class SomeData : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
    ...
    public interface ICaclulatorService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICaclulatorService/DataContractOperation", ReplyAction="http://tempuri.org/ICaclulatorService/DataContractOperationResponse")]
        ClientApp.AutoGeneratedServiceReference.SomeData DataContractOperation(ClientApp.AutoGeneratedServiceReference.SomeData input);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICaclulatorService/DataContractOperation", ReplyAction="http://tempuri.org/ICaclulatorService/DataContractOperationResponse")]
        System.Threading.Tasks.Task<ClientApp.AutoGeneratedServiceReference.SomeData> DataContractOperationAsync(ClientApp.AutoGeneratedServiceReference.SomeData input);
    }
    ...
    public partial class CaclulatorServiceClient : System.ServiceModel.ClientBase<ClientApp.AutoGeneratedServiceReference.ICaclulatorService>, ClientApp.AutoGeneratedServiceReference.ICaclulatorService {
        ...
        public ClientApp.AutoGeneratedServiceReference.SomeData DataContractOperation(ClientApp.AutoGeneratedServiceReference.SomeData input) {
            return base.Channel.DataContractOperation(input);
        }
        
        public System.Threading.Tasks.Task<ClientApp.AutoGeneratedServiceReference.SomeData> DataContractOperationAsync(ClientApp.AutoGeneratedServiceReference.SomeData input) {
            return base.Channel.DataContractOperationAsync(input);
        }
    }
}
